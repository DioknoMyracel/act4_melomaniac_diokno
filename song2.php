            ...
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        echo "<h2 class='text-primary'>Driver's  License</h2>";
                        echo "<p class='lead '>Olivia Rodrigo</p>";
                        echo "<p> [Intro] </p>";
                        echo "<p>I've got my driver's license last week</p>";
                        echo "<p>Just like we always talked about</p>";
                        echo "<p>'Cause you were so excited for me</p>";
                        echo " <p>To finally drive up to your house</p>";
                        echo " <p>But to day I drove through the suburbs</p>";
                        echo " <p>Crying 'cause you weren't arounf</p>";
                        echo " <p>And you're probably with that blond girl</p>";
                        echo " <p>Who always made me  doubt</p>";
                        echo " <p>She was so much older than me</p>";
                        echo " <p>She's everything I'm insecure about</p>";
                        echo " <p> Yeah, today I drove through the suburds</p>";
                        echo " <p> 'Cause  how could I ever love someone else</p>";
                        echo " <p> [Chorus]</p>";
                        echo " <p> And I know we weren't perfect but I never felt this way for no one</p>";
                        echo " <p>And I just can't imagine how you could be so okay now that I'm gone</p>";
                        echo " <p>Guess you didn't mean what you wrote in that song about me </p>";
                        echo " <p> 'Cause you sade forever now I drove alone past your street</p>";
                        echo " <p> [Verse]</p>";
                        echo " <p> And all my friends are tired</p>";
